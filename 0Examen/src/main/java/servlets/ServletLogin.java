...
public class ServletLogin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(botonAlumno!=null && !botonAlumno.isBlank()) {
			...
			Impartidor impartidor= loginImpartidor(Integer.parseInt(request.getParameter("usuario")), request.getParameter("password"));
	 ...
	 * @return
	 */
	private Impartidor loginImpartidor(int id, String password) {

		String passwordImpartidor="damocles";
		Impartidor impartidor=ImpartidoresDao.getImpartidor(id);
		if(impartidor!=null) {
